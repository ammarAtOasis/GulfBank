...
<div id="logo"><a href="{SITE_ROOT}"><img src="{TEMPLATE_ROOT}images/logo.png" width="317" height="38" border="0" alt="{SITE_NAME}"></a></div>
...
<tr valign="top">
<td width="{LEFT_WIDTH}">{BOX_LEFT}<div><img src="{SITE_ROOT}images/e.gif" width="{LEFT_WIDTH}" height="1"></div></td>
<td width="760" class="body_content">