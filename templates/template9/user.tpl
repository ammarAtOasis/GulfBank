<table border="0" cellpadding="0" cellspacing="1" class="content_border" width="100%" style="margin-bottom:20px">
<tr valign="top">
<td style="padding:7px" width="50%" class="whitebg">
...
<td class="graybg" style="padding:10px" width="20%">
