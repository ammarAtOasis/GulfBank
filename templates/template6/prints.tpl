...
<td background="{TEMPLATE_ROOT}images/a_bg.gif" nowrap class="gg">{WORD_PRINTS}</td>
<td><img src="{TEMPLATE_ROOT}images/a_right.gif" width="8" height="21"></td>
<td width="97%" align="right"><a href="javascript:reviews_hide();"><img src="{TEMPLATE_ROOT}images/delete.gif" width="13" height="21" border="0"></a></td>
</tr>
</table>
