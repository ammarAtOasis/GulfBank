...
<div id="logo"><a href="{SITE_ROOT}"><img src="{TEMPLATE_ROOT}images/logo.gif" width="256" height="98" border="0" alt="{SITE_NAME}"></a></div>
...
<div style="padding-top:5px;padding-bottom:10px">Copyright &copy; 2010 <a href="http://www.cmsaccount.com/">Photo Video Store</a> - {WORD_RESERVED}.</div>
</div>
</div>
